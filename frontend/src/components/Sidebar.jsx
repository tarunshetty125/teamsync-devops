/**
 * Sidebar Component
 * Premium navigation sidebar with glassmorphism design.
 */
...
const NAV_ITEMS = [
  ...
  { id: 'monitoring', label: 'Monitoring', icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-logo">
        <svg width="32" height="32" viewBox="0 0 40 40" fill="none">
          ...
          <defs><linearGradient id="sg" x1="0" y1="0" x2="40" y2="40"><stop stopColor="#6366f1"/><stop offset="1" stopColor="#a855f7"/></linearGradient></defs>
        </svg>
      ...
      <div className="sidebar-footer">
        ...
        <button className="logout-btn" onClick={onLogout} title="Sign Out">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9"/></svg>
        </button>
      </div>
    </aside>
  );
